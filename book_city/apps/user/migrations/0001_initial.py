    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='user/', verbose_name='头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_num', models.IntegerField(verbose_name='推荐票数')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='会员用户')),
            ],
            options={
                'verbose_name': '会员信息',
